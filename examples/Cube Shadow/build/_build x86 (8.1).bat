...
echo Compiling x86 Cube Shadow Payload for Windows 8.1...
cl.exe /O2 /EHsc /D_WIN32_WINNT=0x0603 /DWINVER=0x0603 /I"%WIN81_SDK%\Include\um" /I"%WIN81_SDK%\Include\shared" ..\main.cpp /link /LIBPATH:"%WIN81_LIB%" user32.lib gdi32.lib d3d11.lib dxgi.lib d3dcompiler.lib CubeShadow.res /OUT:CubeShadow.exe
if %ERRORLEVEL% EQU 0 (
